...
func (h *userHandler) RegisterUser(c *gin.Context) {
	...
	// struct diatas kita passing sebagai paramater ke service
...
func (h *userHandler) UploadAvatar(c *gin.Context) {
	...
	if err != nil {
		...
		response := helper.APIResponse("Failede to upload avatar image", http.StatusBadRequest, "error", data)

		c.JSON(http.StatusBadRequest, response)
		return
	}

	// harusnya dapat dari JWT, tapi belum dibuat
	userID := 1
